 ...
 * @return void
 */
function acf_tooling_block_register(): void
{
 ...
 */
function acf_tooling_block_register_include_fields(): void
{
 ...
 */
function acf_tooling_block_categories(array $block_categories ): array
{
	...
	$block_categories = array_merge(
		[
			[
				'slug'  => 'acf-blocks',
				'title' => __( 'ACF Blocks', 'acf-tooling-block' ),
...
add_filter( 'block_categories_all', 'acf_tooling_block_categories' );
